...
<td colspan="3" class="sub-section">(1) Current Assets</td>
</tr>
<tr>
<td>(a) Share Capital</td><td></td><td class="right">₹${balanceData.totalPurchase}</td>
<td>(a) Cash & Bank</td><td></td><td class="right">₹${balanceData.totalSales}</td>
</tr>
<tr>
<td>(b) Reserves & Surplus</td><td></td><td class="right">₹${balanceData.profit}</td>
<td>(b) Inventories</td><td></td><td class="right">₹${balanceData.inventoryValue}</td>
</tr>
<tr>
<td colspan="3" class="sub-section">(2) Current Liabilities</td>
...
<td class="right"><b>₹${totalAssets}</b></td>
